...
situation_report_01 setTriggerStatements["true",
		"[area_hq, 'Message received. Make sure you search the building for posssible sympathisers and bring them in.'] 
		remoteExec
		['sideChat', 0];
		missionNamespace setVariable ['ahmaday_patrol_complete', 1, true]",
	""];