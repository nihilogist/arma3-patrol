iedMkr=["iedMkr0","iedMkr1"];	//List of markers to spawn IEDs in
...
iedBlast=["Bo_Mk82", "Rocket_03_HE_F", "HelicopterExploSmall", "M_Mo_82mm_AT_LG"];
// "Bo_Mk82", "Rocket_03_HE_F", "HelicopterExploSmall" - fair size
// "M_Mo_82mm_AT_LG", "Bo_GBU12_LGB" - quite big
// "Bo_GBU12_LGB_MI10" - too big
...

{
	...
	for "_i" from 1 to iedNum do {
		...
		_ied=createMine[_ied,getPosATL _iedR,[],8];
		...
		_trig setTriggerTimeout[1,1,1,true];
			...
			_trig setTriggerStatements[
				"{vehicle _x in thisList && speed vehicle _x>4}count allUnits > 0",
